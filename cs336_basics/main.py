...
def testTokenizer(): 
    ...
    vocabPath = "assignment1-basics/data/output/TinyStoriesV2-GPT4-valid.txt-bytes-cTrue-4-1000-260701231246-7.1-vocab.json"
    mergesPath = "assignment1-basics/data/output/TinyStoriesV2-GPT4-valid.txt-bytes-cTrue-4-1000-260701231246-7.1-merges.json"
